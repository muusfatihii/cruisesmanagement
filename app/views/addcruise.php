...
<form method="POST" action="/cruises/public/cruise/add" enctype="multipart/form-data" class="bg-white w-96 p-6 rounded shadow-sm">
      ...
      <label for="picCruise" class="text-orange-400">Photo de la croisière </label>
    ...
    <button type="button" 
    onClick="location.href='/cruises/public/page/cruiseconfig'" 
    class="bg-orange-500 w-full text-gray-100 py-2 rounded hover:bg-orange-700 transition-colors" 
