...
<table class="table">
  ...
  <tbody id="ports">
    ...
    <tr>
        <td><?=$port->name?></td>
        <td><?=$port->country?></td>
        <td><a href="/cruises/public/page/modifyport/<?=$port->id?>"><i class="bi bi-x"></i></a></td>
        <td><i id="<?=$port->id?>" class="deletePort bi bi-trash"></i></td>
    </tr>
    <?php
        }
    ?>
...
<script src="/cruises/public/js/deletePort.js"></script>
