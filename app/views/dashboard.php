...
<body>
    ...
    <div class="gallery">
        ...
        <div class="content">
            ...
            <button class="buy-1" onclick="window.location.href='/cruises/public/page/cruiseconfig';"></button>
        </div>
        ...
        <div class="content">
            ...
            <h3>Navires</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero ratione assumenda corporis quidem in ipsum repudiandae earum eius impedit distinctio tempora soluta ad nisi accusantium debitis dolor beatae, ullam voluptatibus.</p>
            <button class="buy-1" onclick="window.location.href='/cruises/public/page/shipconfig';"></button>
        </div>
        ...
        <div class="content">
            ...
            <h3>Ports</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero ratione assumenda corporis quidem in ipsum repudiandae earum eius impedit distinctio tempora soluta ad nisi accusantium debitis dolor beatae, ullam voluptatibus.</p>
            <button class="buy-1" onclick="window.location.href='/cruises/public/page/portconfig';"></button>
        </div>
        ...
        <div class="content">
            ...
            <h3>Statistiques</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero ratione assumenda corporis quidem in ipsum repudiandae earum eius impedit distinctio tempora soluta ad nisi accusantium debitis dolor beatae, ullam voluptatibus.</p>
            <button class="buy-1" onclick="window.location.href='/cruises/public/page/stats';"></button>
        </div>
    </div>
